...
<div class="col-xs-12 col-sm-12 col-lg-9 col-md-9">
	...
	<div class="well">
		...
		<input type="hidden" id="edit">
			{!!Form::model($id,['route'=>['tienda.update',$id->id],'role'=>'form','class'=>'form-horizontal','method'=>'PUT','files'=>true])!!}
			...
			{!!Form::open(['route'=>['tienda.destroy',$id->id],'role'=>'form','class'=>'form-horizontal','method'=>'DELETE'])!!}
