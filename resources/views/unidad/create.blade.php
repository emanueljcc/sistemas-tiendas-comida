...
<div class="col-xs-12 col-sm-12 col-lg-9 col-md-9">
	...
	{!!Form::open(['route'=>'unidad.store','method'=>'POST','role'=>'form','class'=>'form-horizontal well','accept-charset'=>'UTF-8','enctype'=>'multipart/form-data','files'=>true])!!}
	<input type="hidden" name="_token" value="{{ csrf_token() }}">
	<legend bgcolor="lightblue">Unidad</legend>
