...
<div class="col-xs-12 col-sm-12 col-lg-9 col-md-9">
	...
	<div class="well">
		...
		<input type="hidden" id="edit">
			{!!Form::model($id,['route'=>['unidad.update',$id->id],'role'=>'form','class'=>'form-horizontal','method'=>'PUT','files'=>true])!!}
						
						@include('unidad.form.form')
						<br>
			...
			{!!Form::open(['route'=>['unidad.destroy',$id->id],'role'=>'form','class'=>'form-horizontal','method'=>'DELETE'])!!}
